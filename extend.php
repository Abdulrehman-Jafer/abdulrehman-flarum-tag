...
use Abdulrehman\Tags\Access;
use Abdulrehman\Tags\Api;
use Abdulrehman\Tags\Content;
use Abdulrehman\Tags\Event\DiscussionWasTagged;
use Abdulrehman\Tags\Listener;
use Abdulrehman\Tags\Post\DiscussionTaggedPost;
use Abdulrehman\Tags\Search\Filter\PostTagFilter;
use Abdulrehman\Tags\Search\Filter\TagFilter;
use Abdulrehman\Tags\Search\FulltextFilter;
use Abdulrehman\Tags\Search\HideHiddenTagsFromAllDiscussionsPage;
use Abdulrehman\Tags\Search\TagSearcher;
use Abdulrehman\Tags\Tag;
use Abdulrehman\Tags\Utf8SlugDriver;
...
return [
    ...
    (new Extend\Settings())
        ->serializeToForum('minPrimaryTags', 'abdulrehman-tags.min_primary_tags')
        ->serializeToForum('maxPrimaryTags', 'abdulrehman-tags.max_primary_tags')
        ->serializeToForum('minSecondaryTags', 'abdulrehman-tags.min_secondary_tags')
        ->serializeToForum('maxSecondaryTags', 'abdulrehman-tags.max_secondary_tags'),
