...
class EditTagModal extends (flarum_common_components_FormModal__WEBPACK_IMPORTED_MODULE_2___default()) {
  constructor() {
    ...
    (0,_babel_runtime_helpers_esm_defineProperty__WEBPACK_IMPORTED_MODULE_0__["default"])(this, "nameTranslationStreams", {});
  }
  oninit(vnode) {
    super.oninit(vnode);
    ...
    for (const locale of this.enabledLocales()) {
      ...
      this.nameTranslationStreams[locale] = flarum_common_utils_Stream__WEBPACK_IMPORTED_MODULE_7___default()(typeof raw[locale] === 'string' ? raw[locale] : '');
    }
  }
  enabledLocales() {
    const locales = (flarum_admin_app__WEBPACK_IMPORTED_MODULE_1___default().data).locales;
  ...
  fields() {
    ...
    items.add('name', m("div", {
      ...
      className: "helpText"
    }, flarum_admin_app__WEBPACK_IMPORTED_MODULE_1___default().translator.trans('flarum-tags.admin.edit_tag.name_help'))), 50);
    if (this.enabledLocales().length) {
      items.add('nameTranslations', m("div", {
        className: "Form-group"
      }, m("label", null, flarum_admin_app__WEBPACK_IMPORTED_MODULE_1___default().translator.trans('flarum-tags.admin.edit_tag.name_translations_heading')), m("p", {
        className: "helpText"
      }, flarum_admin_app__WEBPACK_IMPORTED_MODULE_1___default().translator.trans('flarum-tags.admin.edit_tag.name_translations_text')), this.enabledLocales().map(locale => m("div", {
        className: "Form-group",
        key: locale
      }, m("label", null, locale), m("input", {
        className: "FormControl",
