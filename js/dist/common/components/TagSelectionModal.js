"use strict";
(self["webpackChunkmodule_exports"] = self["webpackChunkmodule_exports"] || []).push([["common/components/TagSelectionModal"],{
...
class TagSelectionModal extends (flarum_common_components_FormModal__WEBPACK_IMPORTED_MODULE_8___default()) {
  ...
  content() {
    ...
    }, flarum_common_helpers_highlight__WEBPACK_IMPORTED_MODULE_5___default()((0,_helpers_tagLabel__WEBPACK_IMPORTED_MODULE_11__.tagDisplayText)(tag), filter)), tag.description() ? m("span", {
  ...
  getFilteredTags() {
    ...
    if (filter) {
      tags = tags.filter(tag => (0,_helpers_tagLabel__WEBPACK_IMPORTED_MODULE_11__.tagDisplayText)(tag).toLowerCase().includes(filter));
    }
