...
class TagHero extends (flarum_forum_components_Hero__WEBPACK_IMPORTED_MODULE_0___default()) {
  className() {
    ...
    const color = tag.color();
    return flarum_common_utils_classList__WEBPACK_IMPORTED_MODULE_3___default()('TagHero', {
...
class TagLinkButton extends (flarum_common_components_LinkButton__WEBPACK_IMPORTED_MODULE_1___default()) {
  view(vnode) {
    ...
    }, (0,_common_helpers_tagIcon__WEBPACK_IMPORTED_MODULE_3__["default"])(tag, {
...
class TagsPage extends (flarum_common_components_Page__WEBPACK_IMPORTED_MODULE_2___default()) {
  ...
  tagTileView(tag) {
    ...
    }, child.name()), ' ']))), lastPostedDiscussion ? m((flarum_common_components_Link__WEBPACK_IMPORTED_MODULE_6___default()), {
